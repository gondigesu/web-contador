...
var contacto = document.querySelector('.item7');
var botoncancelar = document.querySelector('.btn-danger');
var formulario = document.querySelector('form');
var botonenviar = document.querySelector('.btn-primary');
var nombreformulario = document.querySelector('.nombre');
var apellidoformulario = document.querySelector('.apellido');
var mailformulario = document.querySelector('.email');
var inputformulario = document.querySelector('.texto');
var modalrs = document.querySelector('.modalrs');
var modalservicios = document.querySelector('.modalservicios');
var itembio = document.querySelector('.item2');
var itemrs = document.querySelector('.item5');
var itemservicios = document.querySelector('.item4');
var closers = document.querySelector('.closers');
var closebio = document.querySelector('.closebio');
var closeservicios = document.querySelector('.closeservicios');

function itembioHandler() {
  var modalbio = document.querySelector('.modalbio');
...
function validarMail() {
  if (mailformulario.value.length !== 0 && mailformulario.value.indexOf !== '@' - 1 && mailformulario.value.indexOf('.') !== -1) {
    ...
    crearError("Por favor complete un correo electr\xF3nico v\xE1lido.");
  }
...
function crearError(texto) {
  ...
  var errordiv = document.querySelector('.mensajeError');
...
function validarElemento(elemento) {
  elemento.onblur = function () {
    if (elemento.value.length !== 0) {
      ...
      var error = document.createElement('p');
      crearError("Por favor complete el ".concat(elemento.id, "."));
    }
